...
<div class="settings-panel-head"><h2>Expiring Items — Current Store</h2></div>

<form id="reportFilterForm" class="row g-3 mb-3" data-endpoint="{{ route('storage_supplies.reports.expiring_items_data') }}">
    <div class="col-md-6">
