...
<div class="settings-panel-head"><h2>Stock Summary Report</h2></div>

<form id="reportFilterForm" class="row g-3 mb-3" data-endpoint="{{ route('storage_supplies.reports.stock_summary_data') }}">
