...
<div class="settings-panel-head"><h2>Approval Turnaround Report</h2></div>

<form id="reportFilterForm" class="row g-3 mb-3" data-endpoint="{{ route('storage_supplies.reports.approval_turnaround_data') }}">
