{{-- top_suppliers_by_spend.blade.php --}}
@extends('templates.app')

@section('content')
@include('templates.storage_supplies.partials.active_subdepartment_bar')
<div class="settings-panel-head"><h2>Top Suppliers by Spend</h2></div>

<form id="reportFilterForm" class="row g-3 mb-3" data-endpoint="{{ route('procurement.reports.top_suppliers_by_spend_data') }}">
