...
<div class="settings-panel-head"><h2>Driver Performance</h2></div>

<form id="reportFilterForm" class="row g-3 mb-3" data-endpoint="{{ route('fleet.reports.driver_performance_data') }}">
