...
<div class="settings-panel-head"><h2>Cost per Kilometer</h2></div>

<form id="reportFilterForm" class="row g-3 mb-3" data-endpoint="{{ route('fleet.reports.cost_per_km_data') }}">
