...
<div class="settings-panel-head"><h2>Destination Frequency</h2></div>

<form id="reportFilterForm" class="row g-3 mb-3" data-endpoint="{{ route('fleet.reports.destination_frequency_data') }}">
