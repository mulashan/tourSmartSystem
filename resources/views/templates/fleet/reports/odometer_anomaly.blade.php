...
<div class="settings-panel-head"><h2>Odometer Anomaly Report</h2></div>

<form id="reportFilterForm" class="row g-3 mb-3" data-endpoint="{{ route('fleet.reports.odometer_anomaly_data') }}">
    ...
    <div class="col-md-3">
        <label class="form-label">Flag Below (km/day)</label>
        <select name="threshold_km_per_day" class="form-select">
            <option value="10">10 km/day</option>
            <option value="20" selected>20 km/day</option>
