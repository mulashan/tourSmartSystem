...
<div class="settings-panel-head"><h2>Maintenance History</h2></div>

<form id="reportFilterForm" class="row g-3 mb-3" data-endpoint="{{ route('fleet.reports.maintenance_history_data') }}">
