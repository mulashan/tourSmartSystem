...
<div class="settings-panel-head"><h2>Vehicle Downtime</h2></div>

<form id="reportFilterForm" class="row g-3 mb-3" data-endpoint="{{ route('fleet.reports.vehicle_downtime_data') }}">
