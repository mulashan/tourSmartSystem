...
<div class="settings-panel-head"><h2>Accidents & Fines Report</h2></div>

<form id="reportFilterForm" class="row g-3 mb-3" data-endpoint="{{ route('fleet.reports.incidents_data') }}">
    ...
    <div class="col-md-3">
        ...
        <select name="type" class="form-select">
            ...
            <option value="road_fine">Road Fine</option>
        </select>
    </div>
    <div class="col-md-5">
