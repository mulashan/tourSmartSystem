(function whenJQueryReady(fn) {
    ...
    $(function () {
        ...
        let lines = window.returnOutwardExistingLines || [];
        ...
        function savePayload() {
            ...
            return $.post(window.returnOutwardRoutes.update, {
        ...
        $('#js-save-submit-return').on('click', function () {
            const returnId = window.returnOutwardRoutes.update.split('/').pop();

            savePayload()
                .then(() => $.post(`/storage-supplies/return-outward/${returnId}/submit`))
                .then(() => {
