(function whenJQueryReady(fn) {
    ...
    $(function () {
        ...
        let lines = window.returnExistingLines || [];
        ...
        function savePayload() {
            ...
            return $.post(window.returnRoutes.update, {
        ...
        $('#js-save-submit-return').on('click', function () {
            const returnId = window.returnRoutes.update.split('/').pop();

            savePayload()
                .then(() => $.post(`/storage-supplies/return/${returnId}/submit`))
                .then(() => {
